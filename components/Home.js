import React, { Component } from 'react';
	...
	export default class App extends Component
	{
	  state={
		...
		won:"Let's Play, Player X turn",disable:false
    }
		  ...
		  case 1:
			  if(this.state.btn1!=="X" && this.state.btn1!=="O")
			  {
				  if(x_o%2===0)
				  {
					  ...
					  this.setState({won:'Player O turn now'})
					  x_o+=1;
				  }
				  else
				  {
					  ...
					  this.setState({won:'Player X turn now'})
	  ...
	  playagain=()=>
	  {
		  this.setState({btn1:'',btn2:'',btn3:'',btn4:'',btn5:'',btn6:'',btn7:'',btn8:'',btn9:'',
						box1:'',box2:'',box3:'',box4:'',box5:'',box6:'',box7:'',box8:'',box9:'',won:"Let's Play, Player X turn",disable:false
					   })
					   x_o=0;
	  }
	  ...
	  render()
	  {
		...
		return(
		  <View style={styles.container}>
			...
			<Text style={{fontSize:24,color:"#194F9C", fontWeight:'bold', textAlign:'center'}}>{this.state.won}</Text>
			</View>
			<View style={styles.container2}>
				...
				<View style={styles.board}>
				 ...
				 <TouchableOpacity activeOpacity={0.8} style={styles.playagain} onPress={this.playagain} >
					<Text style={{color:'white', textAlign:'center',fontSize:20,color:'#194F9C', fontWeight:'bold'}}>New Game</Text>
				  </TouchableOpacity>
		  </View>
		)
	  }
